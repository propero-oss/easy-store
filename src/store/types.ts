...
export interface ReadOnlyStore<T> extends Subscribable<[value: T, before: T]>, StoreReadAccessors<T> {}
...
export type DependencyValueTypes<T extends Subscribable<unknown[]>[]> = { [Index in keyof T]: StoreValueType<T[Index]> };
export type DeferredValueGenerator<T extends ReadOnlyStore<unknown>[], R> = (...values: DependencyValueTypes<T>) => R;
